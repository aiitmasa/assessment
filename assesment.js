...
assessmentButton.onclick = () => {
  ...
  //＊＊今ある診断結果を削除する＊＊
  removeAiiChidren(resultDivided); //診断結果表示エリアの最初の子要素を削除する
  removeAiiChidren(tweetDivided); //診断結果表示エリアの最初の子要素を削除する
  ...
  //assessment関数を実行してpタグに診断結果を設定する
...
//入力欄でエンターキーを押した時にも診断結果が表示されるようにする
 ...
 */
function removeAiiChidren(element) {
  //子要素がある限りループする
...
function assessment(userName) {
  ...
  //文字のコードの番号の合計を解答の数で割って添字の数値を求める
